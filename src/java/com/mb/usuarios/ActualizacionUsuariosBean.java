...
public class ActualizacionUsuariosBean {
    ...
    if(sexo.equalsIgnoreCase("hombre"))
        ...
        if(cu.actualizacionUsuarios(matricula, nombre, apellidop, apellidom, sexo, fechaNacmiento, pais, estado, puesto, descripcion,rol))
        RequestContext.getCurrentInstance().execute("dlg_actualizacion.hide(); alert('Actualizacion Exitosa')");
        else
